...
<div class="container-fluid mt-4">
    <div class="row">
        ...
        <ul class="list-group">
         ...
         <div class="col-md-4" >
          <ul class="showrow list-group">
              <li class="list-group-item"><h3><a href="{{ route('products.annonces.index')}}">{{ $annonce->title }}</a></h3></li>
              ...
              <li class="list-group-item">Category: {{ $annonce->identite->name }}</li>
